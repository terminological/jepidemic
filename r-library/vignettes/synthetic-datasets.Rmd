...
The synthetic time series generated in this manner can be used to test estimators of growth rate and R_t, against theoretical values. For validation of accuracy of predictions we use 2 data sets, firstly a period regular function with zero randomness to assess the lag in estimation:
