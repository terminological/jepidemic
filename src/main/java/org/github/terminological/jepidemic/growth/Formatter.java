...
public class Formatter {
	...
	public static Collector<GrowthRateTimeseriesEntry, ?, RDataframe> rtAndGrowthCollector(String dateCol, String incidenceCol) { 
		return RConverter.dataframeCollector(
				...
				RConverter.mapping("Growth.Quantile.0.025.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.025)),
				RConverter.mapping("Growth.Quantile.0.05.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.05)),
				RConverter.mapping("Growth.Quantile.0.25.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.25)),
				RConverter.mapping("Growth.Quantile.0.5.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.5)),
				RConverter.mapping("Growth.Quantile.0.75.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.75)),
				RConverter.mapping("Growth.Quantile.0.95.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.95)),
				RConverter.mapping("Growth.Quantile.0.975.value",s -> s.getSummaryEstimates().getGrowth().quantile(0.975)),
				...
				RConverter.mapping("Est.Quantile.0.025.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.025)),
				RConverter.mapping("Est.Quantile.0.05.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.05)),
				RConverter.mapping("Est.Quantile.0.25.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.25)),
				RConverter.mapping("Est.Quantile.0.5.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.5)),
				RConverter.mapping("Est.Quantile.0.75.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.75)),
				RConverter.mapping("Est.Quantile.0.95.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.95)),
				RConverter.mapping("Est.Quantile.0.975.value",s -> s.getSummaryEstimates().getIncidence().quantile(0.975))
		);
	}
