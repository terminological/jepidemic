...
#' Version: 0.03
#'
#' Generated: 2022-01-03T21:00:49.697782
#'
...
JavaApi = R6::R6Class("JavaApi", public=list( 
    ...
    #' @return nothing
 	initialize = function(logLevel = "INFO") {
		...
		message("Generated: 2022-01-03T21:00:49.697976")
		...
		.jcall(self$.log,returnSig = "V",method = "debug","R package generated: 2022-01-03T21:00:49.698036");
